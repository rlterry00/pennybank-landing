...
async function flush() {
  ...
  for (const pagePath of pagesToWrite) {
    ...
    if (page) {
      var _staticQueriesByTempl, _program$_;

      const staticQueryHashes = ((_staticQueriesByTempl = staticQueriesByTemplate.get(page.componentPath)) === null || _staticQueriesByTempl === void 0 ? void 0 : _staticQueriesByTempl.map(String)) || [];
